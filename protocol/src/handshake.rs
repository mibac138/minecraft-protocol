...
impl Handshake {
    pub fn new(protocol_version: i32, server_addr: String, server_port: u16, next_state: i32) -> HandshakeServerBoundPacket {
        let handshake = Handshake { protocol_version, server_addr, server_port, next_state };
